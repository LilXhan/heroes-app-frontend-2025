    ...
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
      <div className="relative h-64">
        ...
        <div className="absolute top-3 left-3 flex items-center gap-2">
          <div className={`w-3 h-3 rounded-full bg-green-500 ${hero.status === 'Active' ? 'bg-green-500' : 'bg-red-500'}`} />
        ...
        <Button onClick={() => toggleFavorite(hero)} size="sm" variant="ghost" className="absolute bottom-3 right-3 bg-white/90 hover:bg-white">
          <Heart className={`h-4 w-4 ${isFavorite(hero) ? 'fill-red-500 text-red-500' : ' fill-gray-500 text-gray-500'}`} />
        </Button>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <Progress activeColor='bg-orange-500' value={hero.strength * 10} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress activeColor='bg-blue-500' value={hero.intelligence * 10} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress activeColor='bg-green-500' value={hero.speed * 10} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress activeColor='bg-purple-500' value={hero.durability * 10} className="h-2" />
          </div>
        </div>
